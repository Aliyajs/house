    ...
    <footer className={css.footer}>
      <div className={css.footer_box}>
        <div className={css.container}>
          ...
          <p>
            <b>CasHome</b> - is an online service for the sale <br />
            and rental of real estate in Bishkek and <br />
            Kyrgyzstan. We help to buy or rent apartments, <br />
            houses, offices all over the country. Find the best <br />
            options, quickly sell or rent your property with us!{" "}
          </p>
          <div>
      ...
      <h3 className={css.end}>
        Copyright © 2019-2021 CasHome company. All right reserved
      </h3>
    </footer>
  );
}
